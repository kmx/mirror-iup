...
elems[] =
{
  ...
  { "Colorbar",     code_empty,        check_empty,       COLORBAR_H  },
  { "ColorBrowser", code_empty,        check_empty,       CB_H  },
  { "Dial",         code_string,       check_string,      DIAL_H  },
...
void init(void)
{
  ...
  fprintf( outfile,
    "/* Arquivo gerado automaticamente por ledc "VERSION"         */\n"
    "\n"
    "#include <stdlib.h>\n"
    "#include <stdarg.h>\n"
    "#include <iup.h>\n"
